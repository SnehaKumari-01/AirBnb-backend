...
public class AuthController {
    ...
    @PostMapping("/signup/hotelManager")
    public ResponseEntity<UserDto> signupAsHotelManager(@RequestBody SignUpRequestDto signUpRequestDto){
        return new ResponseEntity<>(authService.signUpAsHotelManager(signUpRequestDto), HttpStatus.CREATED);
    }
